...
class bootstrap_5_wp_nav_menu_walker extends Walker_Nav_menu
{
    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
    {
        ...
        $nav_link_class = ($depth > 0) ? 'dropdown-item ' : 'nav-link px-2 text-body-secondary ';
...
register_nav_menus(array(
    'menu-principal' => __('Menu principal', 'Nuevo Tema'),
    'main-menu' => __('Main Menu', 'Nuevo Tema'),
    'footer-menu' => __('Footer Menu', 'Nuevo Tema')
));
