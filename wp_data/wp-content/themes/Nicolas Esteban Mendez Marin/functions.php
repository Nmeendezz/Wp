...
class bootstrap_5_wp_nav_menu_walker extends Walker_Nav_menu
{
    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
    {
        ...
        $nav_link_class = ($depth > 0) ? 'dropdown-item' : 'btn btn-outline-warning border-2 mx-2 my-1';
        $attributes .= ($args->walker->has_children)
            ? ' class="' . $nav_link_class . $active_class . ' dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"'
            : ' class="' . $nav_link_class . $active_class . '"';
...
register_nav_menus(array(
    'menu-principal' => __('Menu principal', 'Nicolas Esteban Mendez Marin')
));
